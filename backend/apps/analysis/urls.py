...
urlpatterns = [
    ...
    path("analysis/<uuid:pk>/reanalyze/", views.ReanalyzeView.as_view(), name="reanalyze"),
    path("analysis/<uuid:pk>/export/", views.ExportAnalysisView.as_view(), name="export-analysis"),
